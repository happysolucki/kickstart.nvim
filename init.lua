...
-- remove padding from terminal & tmux
...
-- Make horizontal split below default
vim.o.splitbelow = true

-- Make vertical split right default
...
-- Set search to highlight incrementally
vim.o.incsearch = true

-- Set vertical scrolloff
vim.o.scrolloff = 8
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'json', 'javascript', 'typescript', 'toml', 'fish', 'vimdoc', 'vim', 'bash', 'dart' },
